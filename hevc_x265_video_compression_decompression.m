function [ reconstructed_vid ] = hevc_x265_video_compression_decompression( image_y, mov, compression_QP, compressed_file, fps, frames )
...
[dontcare1, dontcare2] = system( sprintf('x265.exe --profile main --input %s --input-res %dx%d --fps %d --frames %d --output %s --crf %d --no-info --rd 6 --keyint 8 --min-keyint 8', temp_input_filename, width, height, fps, frames, compressed_file, compression_QP ) );
